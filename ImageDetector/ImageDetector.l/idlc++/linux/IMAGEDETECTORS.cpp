...
#ifndef _TAO_IDL_IDLC___LINUX_IMAGEDETECTORS_CPP_
#define _TAO_IDL_IDLC___LINUX_IMAGEDETECTORS_CPP_
...
class TAO_IMAGEDETECTOR_ImageDetector_ifce_Perfect_Hash_OpTable
...
/* Command-line: ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_IMAGEDETECTOR_ImageDetector_ifce_Perfect_Hash_OpTable -N lookup  */
unsigned int
TAO_IMAGEDETECTOR_ImageDetector_ifce_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
  static const unsigned char asso_values[] =
    {
     ...
     127, 127, 127, 127, 127, 127, 127, 127, 127, 127,
     127, 127, 127, 127, 127, 127, 127, 127, 127, 127,
     127, 127, 127, 127, 127,  10, 127,  55, 127,  50,
      35,  10,  55,  30,   6,   0, 127, 127, 127, 127,
...
TAO_IMAGEDETECTOR_ImageDetector_ifce_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 52,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"expose", &POA_IMAGEDETECTOR::ImageDetector_ifce::expose_skel, 0},
      ...
      {"_get_idExposureTimeLeft", &POA_IMAGEDETECTOR::ImageDetector_ifce::_get_idExposureTimeLeft_skel, 0},
      ...
      {"setExposureTimeSeconds", &POA_IMAGEDETECTOR::ImageDetector_ifce::setExposureTimeSeconds_skel, 0},
      ...
      {"_get_idExposing", &POA_IMAGEDETECTOR::ImageDetector_ifce::_get_idExposing_skel, 0},
  ...
  static const signed short lookup[] =
    {
        -1,   -1,   -1,  -21,   -2,  -25,   -2,    7,   -1,    8,    9,   10,   11,   -1, 
        12,   13,   14,   15,   -1,   16,   17,   18,  -28,   -2,   19,   20, -149,   -1, 
        23,   24, -151,   27,  -30,   -2, -138, -129,  -33,   -2,   32, -129,   35,   36, 
        37,   -1,   38,   39,   -1,   40,   -1,   41,   42,   -1,   43,   -1,   44,   45, 
        -1,   -1,   -1,   46,   47,   -1,   -1,   -1,   48,   49,   -1,   -1,   50,   51, 
...
static TAO_IMAGEDETECTOR_ImageDetector_ifce_Perfect_Hash_OpTable tao_IMAGEDETECTOR_ImageDetector_ifce_optable;

// TAO_IDL - Generated from
// be/be_visitor_interface/interface_ss.cpp:93

POA_IMAGEDETECTOR::ImageDetector_ifce::ImageDetector_ifce (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_IMAGEDETECTOR_ImageDetector_ifce_optable;
}

POA_IMAGEDETECTOR::ImageDetector_ifce::ImageDetector_ifce (const ImageDetector_ifce& rhs)
...
namespace POA_IMAGEDETECTOR
{
  ...
  class expose_ImageDetector_ifce
    : public TAO::Upcall_Command
  {
  public:
    inline expose_ImageDetector_ifce (
      POA_IMAGEDETECTOR::ImageDetector_ifce * servant)
      : servant_ (servant)
    {
    }
    ...
    {
      this->servant_->expose ();
    }
  
  private:
    POA_IMAGEDETECTOR::ImageDetector_ifce * const servant_;
  };
}
...
void POA_IMAGEDETECTOR::ImageDetector_ifce::expose_skel (
  ...
  TAO_ServantBase *servant)
{
  ...
  POA_IMAGEDETECTOR::ImageDetector_ifce * const impl =
    dynamic_cast<POA_IMAGEDETECTOR::ImageDetector_ifce *> (servant);
  ...
  expose_ImageDetector_ifce command (
    impl);
...
namespace POA_IMAGEDETECTOR
{
  ...
  class setExposureTimeSeconds_ImageDetector_ifce
    : public TAO::Upcall_Command
  {
  public:
    inline setExposureTimeSeconds_ImageDetector_ifce (
      POA_IMAGEDETECTOR::ImageDetector_ifce * servant,
    ...
    virtual void execute (void)
    {
      ...
      this->servant_->setExposureTimeSeconds (
        arg_1);
    }
...
void POA_IMAGEDETECTOR::ImageDetector_ifce::setExposureTimeSeconds_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  setExposureTimeSeconds_ImageDetector_ifce command (
    impl,
...
namespace POA_IMAGEDETECTOR
{
  ...
  class _get_idExposing_ImageDetector_ifce
    : public TAO::Upcall_Command
  {
  public:
    inline _get_idExposing_ImageDetector_ifce (
      POA_IMAGEDETECTOR::ImageDetector_ifce * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
...
void POA_IMAGEDETECTOR::ImageDetector_ifce::_get_idExposing_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  _get_idExposing_ImageDetector_ifce command (
    impl,
    server_request.operation_details (),
    args);
...
namespace POA_IMAGEDETECTOR
{
  ...
  class _get_idExposureTimeLeft_ImageDetector_ifce
    : public TAO::Upcall_Command
  {
  public:
    inline _get_idExposureTimeLeft_ImageDetector_ifce (
      POA_IMAGEDETECTOR::ImageDetector_ifce * servant,
      TAO_Operation_Details const * operation_details,
      TAO::Argument * const args[])
      : servant_ (servant)
    ...
    virtual void execute (void)
    {
      ...
      retval =
        this->servant_->idExposureTimeLeft ();
    }
...
void POA_IMAGEDETECTOR::ImageDetector_ifce::_get_idExposureTimeLeft_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  _get_idExposureTimeLeft_ImageDetector_ifce command (
    impl,
    server_request.operation_details (),
    args);
...
::CORBA::Boolean POA_IMAGEDETECTOR::ImageDetector_ifce::_is_a (const char* value)
{
  return
    (
      ACE_OS::strcmp (
...
const char* POA_IMAGEDETECTOR::ImageDetector_ifce::_interface_repository_id (void) const
{
...
void POA_IMAGEDETECTOR::ImageDetector_ifce::_dispatch (
...
IMAGEDETECTOR::ImageDetector_ifce *
POA_IMAGEDETECTOR::ImageDetector_ifce::_this (void)
{
  ...
  typedef ::IMAGEDETECTOR::ImageDetector_ifce STUB_SCOPED_NAME;
  return
