...
#ifndef _TAO_IDL_IDLC___LINUX_IMAGEDETECTORS_H_
#define _TAO_IDL_IDLC___LINUX_IMAGEDETECTORS_H_
...
#if !defined (_IMAGEDETECTOR_IMAGEDETECTOR_IFCE__SARG_TRAITS_)
#define _IMAGEDETECTOR_IMAGEDETECTOR_IFCE__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::IMAGEDETECTOR::ImageDetector_ifce>
    : public
...
namespace POA_IMAGEDETECTOR
{
  ...
  public:
    ...
    typedef ::IMAGEDETECTOR::ImageDetector_ifce _stub_type;
    typedef ::IMAGEDETECTOR::ImageDetector_ifce_ptr _stub_ptr_type;
    typedef ::IMAGEDETECTOR::ImageDetector_ifce_var _stub_var_type;

    ImageDetector_ifce (const ImageDetector_ifce& rhs);
    ...
    ::IMAGEDETECTOR::ImageDetector_ifce *_this (void);
    ...
    static void setExposureTimeSeconds_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
    ...
    static void _get_idExposing_skel (
        TAO_ServerRequest &server_request,
        TAO::Portable_Server::Servant_Upcall *servant_upcall,
        TAO_ServantBase *servant);
