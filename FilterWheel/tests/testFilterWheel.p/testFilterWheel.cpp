...
int main(int argc, char** argv)
{
	...
	devicename = cl.getOption("-name", "Test/FilterWheel_1");
	...
	do
	{
		...
		case 2: // Start
			...
			{
				ex.addToTrace("testFilterWheel::start");
				cerr << ex;
			}
			break;
		...
		case 3: // Init
			...
			{
				ex.addToTrace("testFilterWheel::init");
				cerr << ex;
			}
			break;
		...
		case 4: // State
			...
			{
				ex.addToTrace("testFilterWheel::state");
				cerr << ex;
			}
			break;
		...
		case 5: // Report
			...
			{
				ex.addToTrace("testFilterWheel::report");
				cerr << ex;
			}
			break;
		...
		case 6: // Enable/disable
			...
			{
				ex.addToTrace("testFilterWheel::enable/disable");
				cerr << ex;
			}
			break;
		...
		case 7: // Halt
			...
			{
				ex.addToTrace("testFilterWheel::halt");
				cerr << ex;
			}
			break;
		...
		case 8: // Shutdown
			...
			{
				ex.addToTrace("testFilterWheel::shutdown");
				cerr << ex;
			}
			break;
		...
		case 9: // Destroy
			...
			{
				ex.addToTrace("testFilterWheel::destructor");
				cerr << ex;
			}
			break;
		...
		case 10: // Call specific methods
			...
			{
				ex.addToTrace("testFilterWheel::specific methods");
				cerr << ex;
			}
			break;
