...
/**
* FILTERWHEEL/_FilterWheel_ifceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from FILTERWHEEL.idl
* Sunday, May 21, 2023 3:43:39 PM UTC
*/

public class _FilterWheel_ifceStub extends org.omg.CORBA.portable.ObjectImpl implements FILTERWHEEL.FilterWheel_ifce
{


  // Specific FilterWheel operations
  public void moveCommand (FILTERWHEEL.Filter position) throws DGT.GCSException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("moveCommand", true);
                FILTERWHEEL.FilterHelper.write ($out, position);
                $in = _invoke ($out);
                return;
  ...
  public FILTERWHEEL.Filter filterWheelFilter ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_filterWheelFilter", true);
                $in = _invoke ($out);
                FILTERWHEEL.Filter $result = FILTERWHEEL.FilterHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return filterWheelFilter (        );
            } finally {
                _releaseReply ($in);
            }
  } // filterWheelFilter

  public boolean filterWheelMoving ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_filterWheelMoving", true);
                $in = _invoke ($out);
